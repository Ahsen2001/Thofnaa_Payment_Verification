...
export const Button = React.forwardRef<HTMLButtonElement, ButtonProps>(
  (
    ...
    const baseStyles =
      "inline-flex items-center justify-center font-medium rounded-xl transition-all duration-200 focus:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 disabled:opacity-60 disabled:cursor-not-allowed select-none cursor-pointer touch-manipulation active:scale-[0.98]";
    ...
    const sizeStyles = {
      sm: "min-h-[40px] sm:min-h-[36px] px-3 py-2 text-xs gap-1.5 rounded-lg",
      md: "min-h-[48px] sm:min-h-[42px] px-4 py-2.5 text-sm gap-2 rounded-xl",
      lg: "min-h-[52px] sm:min-h-[48px] px-6 py-3.5 text-base gap-2.5 rounded-xl font-semibold",
    };
